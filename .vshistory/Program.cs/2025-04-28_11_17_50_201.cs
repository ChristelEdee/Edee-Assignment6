namespace Edee_Assignment6
{
    internal class Program
    {
        ...
        {
            byte cardsPerHand = CardsPerHandValidation();
        }
        ...
        static byte CardsPerHandValidation()
        {
            const byte MAX_NUM = 3; //Last choice for main menu
            ...
            while (successfulConversion == false || userInput > MAX_NUM || userInput < MIN_NUM)
            {
                Console.Write($"What you entered was not a valid choice. Try again: ");
                successfulConversion = byte.TryParse(Console.ReadLine(), out userInput);
            }
